...
def lstmmodel(input_nodes, lstm_node, hidden_layer, output_nodes, lr = 0.001, pca_variance = None, std_pca=None, dropout=True):
    # definition
    model = Sequential()
...
if __name__ == '__main__':
    ...
    for repeat in range(10):
        X_train_3d, X_test_3d, Y_train, Y_test = dataSplit(AF_X, AF_Y, ratio=0.8,seed=repeat)
        ...
        # model analysis
        r2_score, rmse, mae, mre = modelAnalysis(Y_test, Y_test_pred, verbose=False)
        savemat("result {}.mat".format(repeat), mdict={'Prediction': Y_test_pred, 'True': Y_test,
